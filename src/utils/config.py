...
def init_config(args):
    ...
    _CONFIG_DIR = os.path.normpath(os.path.abspath(os.path.dirname(args.config)))
    ...
    config["trainer"]["save_dir"] = os.path.normpath(os.path.join(_CONFIG_DIR, config["trainer"]["save_dir"]))
