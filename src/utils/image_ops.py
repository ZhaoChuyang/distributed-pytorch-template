...
def read_image(path: str, backend: str = "PIL") -> Image:
    ...
    The image file should have the extension in ['.png', '.jpg', '.jpeg', '.bmp']
    """
...
def convert_tensor_to_image(input: torch.Tensor, data_range: Tuple = (0., 1.), input_order="CHW") -> np.ndarray:
    """
    Args:
