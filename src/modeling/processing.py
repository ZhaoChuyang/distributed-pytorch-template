...
__all__ = ['pad_collate_images', 'remove_padding', 'normalize_to_neg_one_to_one', 'unnormalize_to_zero_to_one']


def pad_collate_images(images: List[Tensor], size_divisibility: int = 1, pad_value: float = 0.0):
    """
    Pad the input images of variant shapes to the same shape, then collate them into a single Tensor.
